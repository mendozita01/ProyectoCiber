...
-- =========================================================
-- =========================================================
-- CONTRAMEDIDA (A04): las contraseñas ya NO se calculan con
-- MD5() dentro del propio SQL. Se insertan hashes bcrypt
-- (algoritmo con salt individual embebido en cada hash, costo
-- factor 12) generados previamente en Python con la librería
-- bcrypt. Las contraseñas en texto plano siguen siendo las
-- mismas de la version vulnerable solo para fines de demo:
--   admin      -> Admin123
--   soporte1   -> Soporte123
--   analista1  -> Analista123
-- Para regenerar estos hashes (por ejemplo con otras
-- contraseñas), usar el script technova_app/backend/generar_hash.py
-- =========================================================
...
VALUES
('V-12345678', 'Adriana', 'Rojas', 'adriana.rojas@technova.local', '+58 412-1112233', 'Caracas, Venezuela', 'admin', '$2b$12$jZ1Hw7xBYS/j6EniNPTnu.5BhJvNVhEwSgDzFy7CFuuybPTigjX9a', 'admin'),
('V-23456789', 'Miguel', 'Hernández', 'miguel.hernandez@technova.local', '+58 414-2223344', 'Caracas, Venezuela', 'soporte1', '$2b$12$1i7E/2JlyOTlqz0Tpcrd0.N111VhLB/VyTPjZbHhImiLPe8im82Di', 'soporte'),
('V-34567890', 'Valeria', 'Castillo', 'valeria.castillo@technova.local', '+58 424-3334455', 'Caracas, Venezuela', 'analista1', '$2b$12$NmV0aczPYyDJu7sUlw8Ka.m.UrW5c2FUE9rm4mMtjbZkltgPt/xVe', 'analista');
